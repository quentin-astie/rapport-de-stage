...
// FIXME: Bug with chromium recent version when we reload the page with scroll
...
Range.prototype.myGetExtensionRect = function() {
    ...
    if(previousSibling) {
        ...
        if(onlyWhiteSpaceBefore) {
            ...
            // FIXME: temporary fix the chromium bug
            //return prevSibRect;
            return rect;
...
module.exports = (function(window, document) { "use strict";
    ...
    var cssRegions = {
        ...
        extractOverflowingContent: function(region, dontOptimize) {
            ...
            //
            // FIXME: By Alex. added 1pt because it sometimes skips the last line
            var sizingH = region.cssRegionHost.offsetHeight + 1; // avail size (max-height)
